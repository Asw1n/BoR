...
/**
 * The BoRController controls the PC side of the BoR system. It instructs the
 * sequencer to play a song and links a synthesizer and a BoR Conductor to the
 * sequencer.
 * 
 * @author Aswin
 * 
...
public class BoRController {
	...
	public void setSynthesizer(final Synthesizer synthesizer) {
	...
	private void connect() {
		...
		for (final InstrumentMusicianMap mapping : song.getMapping()) {
