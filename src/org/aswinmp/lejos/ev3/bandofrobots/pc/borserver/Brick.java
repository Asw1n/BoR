...
public class Brick extends lejos.hardware.BrickInfo {
	...
	/**
	 * Midi events can be buffered for sending to the remote brick. Buffered
	 * Mode has the advantage of not holding up the stream of Midi events.
	 * 
	 * @param bufferedMode
	 */
	...
	public void connect() {
		if (hub == null) {
			try {
				...
				System.err
						.println("Connection refused. Check if musician is running on the brick.");
				hub = null;
			}
		}
	}
