...
public class Drumm3rSing3rTest extends AbstractBandTest {
  ...
  public static void main(final String[] args) {
    ...
    final BandConfiguration bandConfiguration = new BandConfiguration("TestDrumm3rSing3r", BorFilePathCreator
        .assembleAbsoluteFileFromUserDir("MIDI", MIDI_FILE_NAME));
    bandConfiguration
