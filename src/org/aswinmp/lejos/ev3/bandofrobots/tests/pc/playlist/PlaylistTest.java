...
public class PlaylistTest extends AbstractBorPCTest {
	...
	private void runTest() throws MidiUnavailableException {
		// create playlist
		final BandConfiguration bandConfiguration1 = new BandConfiguration(
				"TestDrumm3rSing3r", createMidiFile(MIDI_FILE_NAME_1));
		bandConfiguration1.add(new MusicianConfiguration("Drumm3r", 9,
				AssignmentType.MUSICIAN));
		bandConfiguration1.add(new MusicianConfiguration("Sing3r", 5,
				AssignmentType.SINGER));
		final PlaylistEntry playlistEntry1 = new PlaylistEntry(
				bandConfiguration1, PlaylistEntryState.WAITING);
		final BandConfiguration bandConfiguration2 = new BandConfiguration(
				"TestDrumm3rSing3r", createMidiFile(MIDI_FILE_NAME_2));
		bandConfiguration2.add(new MusicianConfiguration("Drumm3r", 9,
				AssignmentType.MUSICIAN));
		bandConfiguration2.add(new MusicianConfiguration("Sing3r", 5,
				AssignmentType.SINGER));
		final PlaylistEntry playlistEntry2 = new PlaylistEntry(
				bandConfiguration2, PlaylistEntryState.WAITING);
		final Playlist playlist = new Playlist("PlaylistTest", playlistEntry1,
				playlistEntry2);
